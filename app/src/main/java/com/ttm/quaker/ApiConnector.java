...
public class ApiConnector {
    public JSONArray GetAllRecipes()
    {
        ...
        String url = "http://10.0.2.2:8888/Quaker_Users/android_connect/get_all_recipes.php";
    ...
    public JSONArray GetProductDetails(int Recipe) {
        // URL for getting all customers


        String url = "http://10.0.2.2:8888/Quaker_Users/android_connect/get_product_details.php?pid="+Recipe;
